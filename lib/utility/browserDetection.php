...
class browserDetection
{
	...
	Special thanks to alanjstr for cleaning up the code, especially on public function get_item_version(),
	...
	******************************************
	...
	This change will will NOT break your existing programming or browser detection public function calls.
	...
	**************************
	FULL ARRAY RETURN OPTIONS:
	 ...
	 To get this return, you use the 'full' or 'full_assoc' value in the public function call, like:
	...
	******************************************************************************
	ALPHABETICAL DESCRIPTION OF DATA OPTIONS (With 'full' numeric index key first)
	  ...
	  any of these individually in the public function call, like:
	...
	******************************************
	...
	argument used in the public function call if used, like: browser_detection( 'full', '1' );
	...
	*******************************************/
	...
	public function browser_detection( $which_test, $test_excludes='', $external_ua_string='' )
	{
		...
		**/
		if ( !$b_repeat ) {
			...
			**/
			$a_webkit_types = array( 'arora', 'bolt', 'beamrise', 'chromium', 'puffin', 'edge', 'chrome', 'crios', 'dooble', 'epiphany', 'gtklauncher', 'icab', 'konqueror', 'maxthon',  'midori', 'omniweb', 'opera', 'qupzilla', 'rekonq', 'rocketmelt', 'samsungbrowser', 'silk', 'uzbl', 'ucbrowser', 'ucweb', 'shiira', 'sputnik', 'steel', 'teashark', 'safari',  'applewebkit', 'webos', 'xxxterm', 'webkit' );
			/**
			...
			**/
			...
			to true so the public function won't retest everything
			**/
			$b_repeat = true;
			/**
	...
	public function returns browser number, gecko rv number, or gecko release date
	public function get_item_version( $browser_user_agent, $search_string, $substring_length )
	...
	**/
	public function check_is_mobile( $pv_browser_user_agent )
	{
		...
		This list is almost the same but not exactly as the 4 arrays in public function below
		**/
